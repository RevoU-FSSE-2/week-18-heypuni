...
productRouter
    ...
    .get(auth('getProductAll'), validate(productValidation.getProductAll), productController.getProductAll);

productRouter
    .route('/:productId')
    .get(auth('getProductAll'), validate(productValidation.getProduct), productController.getProduct)
 ...
 *               priority: low
 *               dueDate: 2021-01-01
 *               createdBy: 6538ed57b567e50cbcbc9356
 *     responses:
 *       "200":
 *         description: OK
 *         content: 
